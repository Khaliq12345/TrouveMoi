<template>
    <v-list-item v-if="!mini" class="pa-4 bg-transparent">
        ...
        <v-switch v-model="isOpenNow" hide-details density="compact" color="primary" inset
            @update:model-value="toggleOpenNow" />
    </v-list-item>
    <v-chip v-else @click="toggleOpenNow" size="small" variant="outlined" class="mx-1 text-caption"
