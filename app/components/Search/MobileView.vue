    ...
    <v-sheet class="fill-height d-flex flex-column bg-transparent">
      ...
      >
        ...
        <v-btn-toggle
          ...
          mandatory
        >
          <v-btn value="carte" class="text-caption text-none">Carte</v-btn>
          <v-btn value="video" class="text-caption text-none">Vidéo</v-btn>
        </v-btn-toggle>
      ...
      <v-sheet color="transparent" class="flex-grow-1 overflow-hidden">
        <!-- Map view -->
        <v-sheet
          v-if="viewMode === 'carte'"
          color="transparent"
        ...
        >
          <span class="text-h6 text-center">Vue Carte</span>
        </v-sheet>

        <!-- Video view -->
        <SearchMobileVideoView v-else />
      </v-sheet>

      <!-- The bottom section for the mobile screen, it contains the data -->
      <search-mobile-bottom-section
        v-model:resultsSheet="resultsSheet"
      ></search-mobile-bottom-section>
    </v-sheet>
  </v-main>
</template>
