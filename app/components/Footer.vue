        ...
        <v-row>
          ...
          <v-col cols="12" sm="6" md="3">
            ...
            <div class="d-flex flex-column ga-2">
              ...
              >
                {{ link.title }}
                <v-icon icon="mdi-arrow-top-right" size="14" class="ms-1 arrow-icon" />
              </a>
            </div>
          </v-col>
          ...
          <v-col cols="12" sm="6" md="3">
            ...
            <div class="d-flex ga-3">
              <v-btn
                ...
                color="white"
                :class="['rounded-lg border-opacity-25', { 'bg-opacity-20': selectedLang === lang.code }]"
                @click="selectedLang = lang.code"
              >
                <template v-slot:prepend>
                  <span class="text-h6 me-n1">{{ lang.flag }}</span>
                </template>
                <span class="text-caption font-weight-bold">{{ lang.label }}</span>
              </v-btn>
            </div>
          </v-col>
        </v-row>
...
const aboutText = 'Votre plateforme de référence pour découvrir les trésors du Bénin. Nous connectons les passionnés aux artisans locaux.'
const aboutTags = ['Artisanat', 'Culture', 'Tourisme']
