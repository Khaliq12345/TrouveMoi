        ...
        <v-card variant="flat" class="pa-2 rounded-lg" color="transparent">
            ...
            >
                ...
                <v-btn
                    ...
                    :append-icon="
                        showAll[key] ? 'mdi-chevron-up' : 'mdi-chevron-down'
                    "
...
const trendingSearches = [
    "Route des Pêches",
    "Ganvié Tourisme",
    "Festival de Porto-Novo",
    "Prix de l'essence",
    "Recrutement Police Républicaine",
    "Mariage Traditionnel",
    "Résultats BEPC 2024",
    "Marché Dantokpa",
    "Sèmè-Kpodji Emploi",
    "Appartement à louer Calavi",
    "Code du numérique",
    "Zémidjan tarifs",
    "Législation foncière",
    "Investir au Bénin",
    "Art contemporain Béninois",
    "Amazon de Cotonou",
];
