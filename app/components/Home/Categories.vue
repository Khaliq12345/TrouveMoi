...
<template>
    ...
    <v-sheet class="py-8 px-4 rounded-3xl" flat color="transparent">
...
interface Category {
    ...
    bgDark: string;
    count: number;
    route: string; // Ou `/categories/${string}` pour plus de précision
}
...
const categories: Category[] = [
    {
        id: 1,
        name: "Restaurants",
        tagline: "Saveurs locales & internationales",
    ...
    },
    {
        id: 3,
        name: "Boutiques",
        tagline: "Shopping & artisanat",
        icon: "mdi-shopping",
        color: "#FF6B9D",
        bgLight: "#FFF0F5",
        bgDark: "#FFD4E2",
        count: 532,
        route: "/categories/boutiques",
    },
    {
        id: 4,
        name: "Services",
        tagline: "Professionnels du quotidien",
        icon: "mdi-tools",
        color: "#45B7D1",
        bgLight: "#EBF7FA",
        bgDark: "#C4E8F0",
    ...
    },
    {
        id: 5,
        name: "Santé",
        tagline: "Cliniques & pharmacies",
        icon: "mdi-hospital-box",
        color: "#E74C3C",
        bgLight: "#FDEDEC",
        bgDark: "#F5B7B1",
        count: 76,
        route: "/categories/sante",
    },
    {
        id: 6,
        name: "Éducation",
        tagline: "Écoles & formations",
        icon: "mdi-school",
        color: "#9B59B6",
        bgLight: "#F5EEF8",
        bgDark: "#D7BDE2",
    ...
    },
    {
        id: 7,
        name: "Loisirs",
        tagline: "Sorties & divertissements",
        icon: "mdi-party-popper",
        color: "#F39C12",
        bgLight: "#FEF5E7",
        bgDark: "#FAD7A0",
        count: 156,
        route: "/categories/loisirs",
    },
    {
        id: 8,
        name: "Transports",
        tagline: "Taxi, bus & location",
        icon: "mdi-car",
        color: "#27AE60",
        bgLight: "#EAFAF1",
        bgDark: "#ABEBC6",
        count: 203,
        route: "/categories/transports",
    },
];
</script>
