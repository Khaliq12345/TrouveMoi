<template>
  <v-container class="pa-0 py-6">
    ...
    <div class="text-body-2 text-grey-darken-2 mb-4 line-clamp-3">
      {{ description || "" }}
    </div>
    ...
    <v-btn
      ...
      @click="showFullAbout = true"
    >
      Afficher plus
    </v-btn>

    <DetailAboutModal
      v-model="showFullAbout"
      :title="businessName || ''"
...
<style scoped>
/* Ensures text cuts off nicely with an ellipsis (...) after 3 lines */
.line-clamp-3 {
  display: -webkit-box;
  line-clamp: 3;
